...
func Test_Array_key_exists(t *testing.T) {
	...
	Convey("检查： Array_key_exists", t, func() {
		toMaps := map[interface{}]interface{}{"123":"123", "234":"234"}
		//toMaps := []string{"123", "234"}
		processRet1 := funArray.Array_key_exists("123", toMaps)
		log.Println("processRet1 return is ", processRet1)
		processRet2 := funArray.Array_key_exists("234", toMaps)
		processRet3 := funArray.Array_key_exists("", toMaps)
